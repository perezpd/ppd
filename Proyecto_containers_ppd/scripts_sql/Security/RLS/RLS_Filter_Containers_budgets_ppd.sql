...
INSERT INTO [Mgmt].[budgets_rls_ppd]
     ...
     VALUES
       (GETDATE(),'Contenerdor Seminuevo con abolladura en lateral exterior izquierdo por impacto. Venta por valor de 5600 Euros',1002,(Select USer)),
		   (GETDATE(),'Contenedor 20 pies n� serie 3241314 por 4560�',1001,(Select USer))
...
--1002	2021-05-31	Contenedor 20 pies n� serie 3241314 por 4560�	1001	VendedorAngel
REVERT
...
INSERT INTO [Mgmt].[budgets_rls_ppd]
     ...
     VALUES
       (GETDATE(),'Contenerdor Seminuevo con abolladura. Venta rebajada por valor de 5400 Euros',1002,(Select USer)),
		   (GETDATE(),'Contenedor 40 pies n� serie 3242513 por 3860�',1001,(Select USer))
...
--1004	2021-05-31	Contenedor 40 pies n� serie 3242513 por 3860�	1001	VendedorVeronica
REVERT
...
INSERT INTO [Mgmt].[budgets_rls_ppd]
           ([fecha],[notas],[cliente_ppd_id_cliente], [OfferedBy])
     VALUES
		   (GETDATE(),'Contenedor 20 pies n� serie 11234 por 3860�',1003,'VendedorAngel')
...
--1003	2021-05-31	Contenerdor Seminuevo con abolladura. Venta rebajada por valor de 5400 Euros	1002	VendedorVeronica
--1004	2021-05-31	Contenedor 40 pies n� serie 3242513 por 3860�	1001	VendedorVeronica
--1005	2021-05-31	Contenedor 20 pies n� serie 11234 por 3860�	1003	VendedorAngel
...
-- Conclusion, users can insert for others, but cannot select or modify with update or delete rows who break the row security policy
-- Moreover she is not able to update the row she inserted 
