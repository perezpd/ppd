...
USE [master]
GO
DROP DATABASE IF EXISTS PruebaFilestream
GO
CREATE DATABASE PruebaFilestream
go
...
ALTER DATABASE [PruebaFilestream] REMOVE FILE MyDB_filestream;
GO

--Msg 5042, Level 16, State 13, Line 134
--The file 'MyDB_filestream' cannot be removed because it is not empty.
...
--The file 'MyDB_filestream' has been removed.
...
ALTER DATABASE [PruebaFilestream] REMOVE FILEGROUP  [PRIMARY_FILESTREAM]
GO

-- The filegroup 'PRIMARY_FILESTREAM' has been removed.

DROP DATABASE [PruebaFilestream]
GO
