...
CREATE TABLE Localidad_cp 
    (
     ...
     Municipio_Provincia_PK_provincia INTEGER NOT NULL 
    )
GO

ALTER TABLE Localidad_cp ADD CONSTRAINT Localidad_cp_PK PRIMARY KEY CLUSTERED (PK_localidad, Municipio_Provincia_PK_provincia)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE Localidad_cp 
    ...
    ( 
     ...
     Municipio_Provincia_PK_provincia
    ) 
